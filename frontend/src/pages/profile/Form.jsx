    ...
    return (
        <div className='formContainer'>
            ...
            <div className='imgContainer'>
                <img src='https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/golden-retriever-royalty-free-image-506756303-1560962726.jpg?crop=0.672xw:1.00xh;0.166xw,0&resize=640:*' alt='Avatar'></img>
            </div>
            ...
            <div className="form-group">
                ...
                <input  className="form-control" 
                    placeholder="06********" pattern='[0-9]{10}'
                />
            </div>

            <div className="form">
            <select id="day" name="day" className='selectForm'>
                <option>day</option>
            ...
            <select id="month" name="month" className='selectForm'>
                <option>month</option>
            ...
            <select id="year" name="year" className='selectForm'>
                <option>year</option>
